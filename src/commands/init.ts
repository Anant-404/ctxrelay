...
export async function runInit(): Promise<void> {
  ...
  // Friendly summary.
  console.log(pc.green("✓ agentbridge initialized"));
  ...
  console.log(`    ${pc.bold("agentbridge context")}   read to get oriented`);
  console.log(`    ${pc.bold("agentbridge handoff")}   write an exit note before stopping`);
  console.log(`    ${pc.bold("agentbridge index")}     refresh the codebase map`);
}
